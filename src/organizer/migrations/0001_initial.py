# Generated by Django 3.1.4 on 2020-12-15 06:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("slug", AutoSlugField(blank=True, editable=False, help_text="A label for URL config.", max_length=31, populate_from=["name"],)),
                 ],
            options={
                'ordering': ['name'],
            },
